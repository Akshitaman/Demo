  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-3">
        ...
        <p className="text-xs text-cyan-400/75">Generating questions...</p>
      </div>
    );
  }
                ...
                {q.options.map((opt, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={cn(
                        "p-2 rounded flex items-center justify-between text-xs",
                        bgClass,
                      )}
                    >
                      <span>{opt}</span>
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="mb-4 flex justify-between items-center text-xs text-muted-foreground">
        ...
        <span className="font-mono text-primary text-[10px] bg-primary/10 px-2 py-0.5 rounded-full">
          {quiz.title}
        </span>
      </div>
