...
export function AISidebarPanel({
  ...
  return (
    ...
    >
      <div className="p-4 border-b flex flex-col gap-4 bg-muted/20 shrink-0 border-zinc-200 dark:border-cyan-500/50">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-sm text-foreground dark:text-cyan-400">{getTitle()}</h3>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 rounded-full hover:bg-cyan-400/10 hover:text-cyan-400 transition-colors"
            onClick={onClose}
          >
            <X className="h-4 w-4" />
          </Button>
        ...
        <div className="flex bg-muted rounded-lg p-1 gap-1">
          <Button
            variant="ghost"
            size="sm"
            className={`flex-1 h-7 text-xs rounded-md ${activeTool === "chat" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:bg-background/50 hover:text-foreground"}`}
          ...
          <Button
            variant="ghost"
            size="sm"
            className={`flex-1 h-7 text-xs rounded-md ${activeTool === "summarize" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:bg-background/50 hover:text-foreground"}`}
          ...
          <Button
            variant="ghost"
            size="sm"
            className={`flex-1 h-7 text-xs rounded-md ${activeTool === "quiz" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:bg-background/50 hover:text-foreground"}`}
